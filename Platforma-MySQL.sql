CREATE TABLE `jezyk` (
  ...
  `nazwa_jezyk` varchar(30) COLLATE utf8_polish_ci NOT NULL
...
CREATE TABLE `kategoria` (
  ...
  `nazwa_kategoria` varchar(30) COLLATE utf8_polish_ci NOT NULL,
  `opis_kategoria` text COLLATE utf8_polish_ci NOT NULL,
  `dir_kategoria` text COLLATE utf8_polish_ci,
  `img_kategoria` varchar(100) COLLATE utf8_polish_ci NOT NULL DEFAULT 'default.png'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
CREATE TABLE `konto` (
  ...
  `rola_id` int(11) DEFAULT '1',
  `imie_konto` varchar(20) COLLATE utf8_polish_ci NOT NULL,
  `nazwisko_konto` varchar(30) COLLATE utf8_polish_ci NOT NULL,
  `email_konto` varchar(50) COLLATE utf8_polish_ci NOT NULL,
  `login_konto` varchar(30) COLLATE utf8_polish_ci NOT NULL,
  `haslo_konto` varchar(100) COLLATE utf8_polish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
CREATE TABLE `podkategoria` (
  ...
  `nazwa_podkategoria` varchar(30) COLLATE utf8_polish_ci NOT NULL,
  `opis_podkategoria` text CHARACTER SET utf32 COLLATE utf32_polish_ci NOT NULL,
  `img_podkategoria` varchar(100) COLLATE utf8_polish_ci DEFAULT 'default.png',
  `dir_podkategoria` text COLLATE utf8_polish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
CREATE TABLE `rola` (
  ...
  `nazwa_rola` varchar(30) COLLATE utf8_polish_ci NOT NULL,
  `opis_rola` text COLLATE utf8_polish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
CREATE TABLE `slowo` (
  ...
  `jezyk_id` int(11) DEFAULT '0',
  `nazwa_slowo` varchar(30) COLLATE utf8_polish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
CREATE TABLE `tlumaczenie` (
  `id_tlumaczenie` int(11) NOT NULL,
  `slowo_id_one` int(11) NOT NULL,
  `slowo_id_two` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
CREATE TABLE `wynik` (
  ...
  `data_wynik` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `wynik_wynik` int(11) NOT NULL,
  `komentarz_wynik` varchar(100) COLLATE utf8_polish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
CREATE TABLE `zestaw` (
  ...
  `jezyk_id_one` int(11) DEFAULT '0',
  `jezyk_id_two` int(11) DEFAULT '0',
  `podkategoria_id` int(11) NOT NULL,
  `nazwa_zestaw` varchar(30) COLLATE utf8_polish_ci NOT NULL,
  `ilosc_slowek_zestaw` int(11) NOT NULL DEFAULT '0',
  `data_edycji_zestaw` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `prywatny_zestaw` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
CREATE TABLE `zestawienie` (
  `id_zestawienie` int(11) NOT NULL,
  `tlumaczenie_id` int(11) NOT NULL,
  `zestaw_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
DELIMITER $$
CREATE TRIGGER `slowo_count` AFTER INSERT ON `zestawienie` FOR EACH ROW UPDATE zestaw SET ilosc_slowek_zestaw = ilosc_slowek_zestaw + 1, data_edycji_zestaw=CURRENT_TIMESTAMP WHERE id_zestaw = NEW.zestaw_id
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `slowo_delete` AFTER DELETE ON `zestawienie` FOR EACH ROW UPDATE zestaw SET ilosc_slowek_zestaw = ilosc_slowek_zestaw - 1, data_edycji_zestaw = CURRENT_TIMESTAMP WHERE id_zestaw = OLD.zestaw_id
$$
DELIMITER ;
...
ALTER TABLE `konto`
  ...
  ADD UNIQUE KEY `login_konto` (`login_konto`),
...
ALTER TABLE `tlumaczenie`
  ADD PRIMARY KEY (`id_tlumaczenie`),
  ADD KEY `slowo_id_one` (`slowo_id_one`),
  ADD KEY `slowo_id_two` (`slowo_id_two`);
...
ALTER TABLE `zestaw`
  ...
  ADD KEY `konto_id` (`konto_id`),
  ADD KEY `jezyk_id_one` (`jezyk_id_one`),
  ADD KEY `jezyk_id_two` (`jezyk_id_two`),
  ADD KEY `podkategoria_id` (`podkategoria_id`);

ALTER TABLE `zestawienie`
  ADD PRIMARY KEY (`id_zestawienie`),
  ADD KEY `slowo_id` (`tlumaczenie_id`),
  ADD KEY `zestaw_id` (`zestaw_id`);

ALTER TABLE `jezyk`
  MODIFY `id_jezyk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

ALTER TABLE `kategoria`
  MODIFY `id_kategoria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

ALTER TABLE `konto`
  MODIFY `id_konto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

ALTER TABLE `podkategoria`
  MODIFY `id_podkategoria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

ALTER TABLE `rola`
  MODIFY `id_rola` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

ALTER TABLE `slowo`
  MODIFY `id_slowo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=152;

ALTER TABLE `tlumaczenie`
  MODIFY `id_tlumaczenie` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;

ALTER TABLE `uprawnienia`
  MODIFY `id_uprawnienia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

ALTER TABLE `wynik`
  MODIFY `id_wynik` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

ALTER TABLE `zestaw`
  MODIFY `id_zestaw` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

ALTER TABLE `zestawienie`
  MODIFY `id_zestawienie` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
